...
INSERT INTO Employees (id, type, name, surname, birth_date, birth_place, gender, email, phone, hire_date, department_id, specialty, license_number, secretary_type) VALUES
                                                                                                                                                                        (1, 'MEDICAL_SPECIALIST', 'Marco', 'Rossi', '1980-03-12', 'Milano', 'M', 'marco.rossi@vixhealth.com', '+393331111111', '2015-09-01', 1, 'Cardiology', 'LIC-CARD-001', NULL),
                                                                                                                                                                        (2, 'MEDICAL_SPECIALIST', 'Elena', 'Bianchi', '1985-07-22', 'Torino', 'F', 'elena.bianchi@vixhealth.com', '+393332222222', '2017-04-15', 2, 'Neurology', 'LIC-NEUR-002', NULL),
                                                                                                                                                                        (3, 'MEDICAL_SPECIALIST', 'Luca', 'Verdi', '1978-11-05', 'Roma', 'M', 'luca.verdi@vixhealth.com', '+393333333333', '2012-01-20', 3, 'Radiology', 'LIC-RAD-003', NULL),

                                                                                                                                                                        (4, 'SECRETARY', 'Sara', 'Conti', '1990-05-10', 'Milano', 'F', 'sara.conti@vixhealth.com', '+393334444444', '2020-02-01', 4, NULL, NULL, 'Front Office'),
                                                                                                                                                                        (5, 'SECRETARY', 'Paolo', 'Ferrari', '1988-09-14', 'Bergamo', 'M', 'paolo.ferrari@vixhealth.com', '+393335555555', '2019-06-10', 5, NULL, NULL, 'Admissions'),

                                                                                                                                                                        (6, 'TECHNICIAN', 'Giulia', 'Romano', '1992-12-01', 'Como', 'F', 'giulia.romano@vixhealth.com', '+393336666666', '2021-03-18', 4, NULL, NULL, NULL),
                                                                                                                                                                        (7, 'TECHNICIAN', 'Andrea', 'Gallo', '1987-02-25', 'Pavia', 'M', 'andrea.gallo@vixhealth.com', '+393337777777', '2018-11-05', 6, NULL, NULL, NULL),

                                                                                                                                                                        (8, 'BUYER', 'Francesca', 'Marini', '1991-04-30', 'Milano', 'F', 'francesca.marini@vixhealth.com', '+393338888888', '2022-01-12', 6, NULL, NULL, NULL),
                                                                                                                                                                        (9, 'BUYER', 'Davide', 'Lombardi', '1989-08-08', 'Varese', 'M', 'davide.lombardi@vixhealth.com', '+393339999999', '2021-10-01', 5, NULL, NULL, NULL),

                                                                                                                                                                        (10, 'STAFF_MANAGER', 'Alessia', 'Moretti', '1983-06-16', 'Milano', 'F', 'alessia.moretti@vixhealth.com', '+393330000001', '2016-07-01', 4, NULL, NULL, NULL),
                                                                                                                                                                        (11, 'STAFF_MANAGER', 'Matteo', 'Ricci', '1981-01-19', 'Torino', 'M', 'matteo.ricci@vixhealth.com', '+393330000002', '2014-05-20', 5, NULL, NULL, NULL);
